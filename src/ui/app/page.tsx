...
const DEFAULT_AGENDA = `You are conducting a customer satisfaction survey. Follow this agenda:
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
            ...
            {showAgenda ? (
              <textarea
                ...
                disabled={isCallActive}
                className="w-full h-64 p-3 border rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white text-sm font-mono"
